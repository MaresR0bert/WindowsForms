...
namespace Assignment_1_Agenda
{
    public partial class CreareAgenda : Form
    {
        ...
        {
            MessageBox.Show("Aceasta aplicatie a fost facuta de Mares Robert-Dorian din Grupa 1052");
        }
        ...
        private void pRESSHEREToolStripMenuItem_Click(object sender, EventArgs e)
        {
            _soundplayer.Play();
        }
